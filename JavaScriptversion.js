...
console.log(taskList);
    const task = question()("Please select a task. ");
    ...
    if (taskStatus == "In Progress"){
        const taskPermission = question()("Do you want to vote for completion of this task? [y/n] ")
        if (taskPermission == "y"){
...
function voting (number_of_task, token_wallet_voting){
    ...
    if (token_wallet_voting>=1){
        while (vote_test1 =="fail"){
            const vote_choice = question() ("Do you wish for this action to pass [y/n] ")
